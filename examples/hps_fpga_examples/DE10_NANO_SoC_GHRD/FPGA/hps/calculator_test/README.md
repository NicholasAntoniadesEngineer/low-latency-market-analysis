...
2. Check QSys integration (see FAST_ITERATION_WORKFLOW.md)
...
- **FPGA Design:** `../../ip/custom/calculator/`
- **Integration Guide:** `../../docs/FAST_ITERATION_WORKFLOW.md`
- **Register Map:** `../../ip/custom/calculator/README.md`
